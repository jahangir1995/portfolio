	...
	<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>All Post</h2>
						<div class="box-icon">
					...
					@endif
						<form class="form-horizontal" role="form" action="{{route('post.store')}}" method="post" enctype="multipart/form-data">@csrf
						 ...
						 <fieldset>
							...
							<div class="control-group">
								<label class="control-label" for="selectError1">Select tag</label>
								<div class="controls">
							 ...
							 <div class="control-group">
								...
								<div class="controls">
								  <label class="checkbox inline">
									<input type="checkbox" id="inlineCheckbox1" value="1" name="status" value="option1">Publish
								  </label>	 
								</div>
								</div>
